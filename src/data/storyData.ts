...
export const storyData: StageStory[] = [
  {
    ...
    dialogues: [
      { speaker: 'han', text: '여기는 관악산 기슭에 있던 청동기시대 마을이야. 사람들이 여기서 오래 살았다는 흔적이 남아 있지.' },
  ...
  },
  {
    ...
    dialogues: [
      { speaker: 'han', text: '여기는 관악산 남쪽 기슭의 돌방무덤, 석실분이야. 돌로 방처럼 무덤을 만들었지.' },
  ...
  },
  {
    ...
    dialogues: [
      ...
      { speaker: 'han', text: '특별한 건 글자가 새겨져 있어서 826년에 만들었고, 절 이름이 “중초사”였다는 걸 정확히 알 수 있다는 점이야.' },
      { speaker: 'yang', text: '국내 유일이라서 보물로 지정됐대. 글자는 시간이 지나도 정보를 남겨주거든!' },
      { speaker: 'han', text: '좋아, 이제 기록을 지키는 미션을 시작해볼까?' },
    ],
  },
  {
    stageId: 5,
    ...
    dialogues: [
      { speaker: 'han', text: '와, 바위에 조각된 그림이 보이지? 이건 “마애종”이야.' },
  ...
  },
  {
    ...
    dialogues: [
      ...
      { speaker: 'han', text: '고려시대 비석을 올려두던 받침이야. 머리는 용처럼 생기고, 등에는 육각형 무늬가 촘촘해.' },
  ...
  },
  {
    ...
    dialogues: [
      ...
      { speaker: 'han', text: '무지개처럼 둥근 아치 구조라서 “홍예교”라고도 해. 돌을 잘 맞춰야 튼튼하지!' },
      { speaker: 'yang', text: '“만 년 동안 편하게 쓰라”는 뜻으로 만안교라고 이름 지었고, 만안구 지명도 여기서 왔대.' },
      { speaker: 'han', text: '좋아! 아치 조립 미션으로 다리의 기록을 지켜보자.' },
    ],
  },
  {
    stageId: 9,
    ...
    dialogues: [
      { speaker: 'han', text: '여긴 일제강점기 때 쓰이던 옛 관청 건물이야. 안양에 남은 유일한 건물이라 더 소중해.' },
